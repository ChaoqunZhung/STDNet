...
from lib.models.cfg.neck import CBAM,GatedFusionConv
...
class DLA(nn.Module):
    ...
    def load_pretrained_model(self, data='imagenet', name='dla34', hash='ba72cf86'):
        ...
        if name.endswith('.pth'):
            ...
            model_weights = torch.load("/home/intern_5/zcq/DSFNet/Moving-object-detection/dla34-ba72cf86.pth", map_location='cpu')
...
class STDNet_Static(nn.Module):
    def __init__(self, heads, final_kernel,
                  head_conv, out_channel=0):
        super(STDNet_Static, self).__init__()
