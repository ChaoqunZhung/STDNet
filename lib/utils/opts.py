...
class opts(object):
    def __init__(self):
        ...
        # test
        self.parser.add_argument('--test_split', type=str, default= 'val',help='which split to test on. test | val')
        self.parser.add_argument('--val_type',type=str,default="distance", help='val type. distance | bbox')
        self.parser.add_argument('--nms', action='store_true',
                                 help='run nms in testing.')
        self.parser.add_argument('--K', type=int, default=256,
                                 help='max number of output objects.')
        self.parser.add_argument('--test_real_data', type=bool, default=False,
        ...
        self.parser.add_argument('--weight_name', type=str, default= time_str,
                                 help='name of the save weight.')
        #self.parser.add_argument('--local_rank', type=int, help='local rank for dist',default=0)
    ...
    def parse(self, args=''):
        ...
        opt.save_dir = opt.save_dir + "/" + opt.weight_name
